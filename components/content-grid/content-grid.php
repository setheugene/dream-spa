...
if ( ll_isset( $component_data['full_screen_height'] ) ) {
  ...
  $top_mp_amount = $mp . '-24';
  $bottom_mp_amount = $mp . '-24';
} else {
  $full_screen = '';
  $top_mp_amount = $mpt . '-' . $component_data['top_spacing'];
  $bottom_mp_amount = $mpb . '-' . $component_data['bottom_spacing'];
}
...
<section class="content-grid relative <?php echo $full_screen; ?> <?php echo $background_color; ?> <?php echo $overlay; ?> <?php echo $top_mp_amount; ?> <?php echo $bottom_mp_amount; ?> <?php echo implode( " ", $classes ); ?>" <?php echo ( $component_id ? 'id="'.$component_id.'"' : '' ) ?> data-component="content-grid">
  ...
  <div class="container relative z-10">
    <div class="justify-center row">
      <div class="col w-full <?php echo $component_data['narrow'] == true && $component_data['columns'] !== '1' ? 'xl:w-10/12' : ''; ?>">
        <?php if( $component_data['add_intro'] ) : ?>
          <div class="row">
